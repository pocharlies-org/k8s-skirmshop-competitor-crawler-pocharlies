...
- [ ] Imagenes siguen `:pending`, pero crawler ya tiene CI build smoke y release workflow preparado. Evidence: `.github/workflows/ci.yml`; `.github/workflows/release.yml`; `k8s/manifest.yaml` y `k8s/prober-deployment.yaml` siguen `:pending`.
