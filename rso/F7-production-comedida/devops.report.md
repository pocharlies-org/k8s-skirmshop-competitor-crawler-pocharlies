...
- [x] Add default-deny crawler egress while disabled. Evidence: `k8s/crawler-networkpolicy.yaml` renders `egress: []`.
...
- [blocked] Crawler/prober NetworkPolicies are default-deny only; F7 needs explicit allowlists before activation.
